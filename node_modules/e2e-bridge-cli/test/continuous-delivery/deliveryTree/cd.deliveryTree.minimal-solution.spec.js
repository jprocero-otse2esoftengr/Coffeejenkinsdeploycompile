...
const projectDir = path.resolve(__dirname, '../data/projects/minimal-solution');
...
describe('Continuous delivery', function() {
    it('reads minimal solution configuration correctly', function(done) {
    ...
    it('transforms minimal solution configuration to delivery tree correctly', function() {
        const errors = [];
